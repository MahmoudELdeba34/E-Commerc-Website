...
@NgModule({
  declarations: [
    ...
    AllOrdersComponent,
    BrandDetalisComponent,
    CategoryDetalisComponent,
    ProductsDetalisComponent,
    LoaderComponent,
  ],
  imports: [BrowserModule, AppRoutingModule, ReactiveFormsModule,HttpClientModule,BrowserAnimationsModule,CarouselModule,FormsModule, ToastrModule.forRoot()],
